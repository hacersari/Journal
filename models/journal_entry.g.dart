...
const JournalEntrySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'feelingCategory': PropertySchema(
      id: 1,
      name: r'feelingCategory',
      type: IsarType.string,
    ),
    r'rateTheDay': PropertySchema(
      id: 2,
      name: r'rateTheDay',
      type: IsarType.long,
    ),
...
int _journalEntryEstimateSize(
  ...
  bytesCount += 3 + object.feelingCategory.length * 3;
...
void _journalEntrySerialize(
  ...
  writer.writeString(offsets[1], object.feelingCategory);
  writer.writeLong(offsets[2], object.rateTheDay);
...
JournalEntry _journalEntryDeserialize(
  ...
  final object = JournalEntry(
    ...
    feelingCategory: reader.readString(offsets[1]),
    id: id,
    rateTheDay: reader.readLong(offsets[2]),
...
extension JournalEntryQueryFilter
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition>
      feelingCategoryEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'feelingCategory',
        value: value,
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition>
      feelingCategoryContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition>
      feelingCategoryMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterFilterCondition>
      rateTheDayEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'rateTheDay',
        value: value,
      ));
    });
  }
...
extension JournalEntryQuerySortBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy>
      sortByFeelingCategory() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'feelingCategory', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy>
      sortByFeelingCategoryDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'feelingCategory', Sort.desc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> sortByRateTheDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rateTheDay', Sort.asc);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy>
      sortByRateTheDayDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rateTheDay', Sort.desc);
    });
  }
...
extension JournalEntryQuerySortThenBy
  ...
  QueryBuilder<JournalEntry, JournalEntry, QAfterSortBy> thenByRateTheDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'rateTheDay', Sort.asc);
    });
  }
...
extension JournalEntryQueryWhereDistinct
  ...
  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByFeelingCategory(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'feelingCategory',
          caseSensitive: caseSensitive);
    });
  }

  QueryBuilder<JournalEntry, JournalEntry, QDistinct> distinctByRateTheDay() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'rateTheDay');
    });
  }
...
extension JournalEntryQueryProperty
  ...
  QueryBuilder<JournalEntry, String, QQueryOperations>
      feelingCategoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'feelingCategory');
    });
  }

  QueryBuilder<JournalEntry, int, QQueryOperations> rateTheDayProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'rateTheDay');
    });
  }
